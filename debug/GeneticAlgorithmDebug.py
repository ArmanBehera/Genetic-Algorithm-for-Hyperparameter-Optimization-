...
p2 = "11111111111111111111111111111111"
...
obj = GenHyperOptimizer(model=linear_model.ElasticNet, search_space=hyperparametersRange, scoring=mean_absolute_error, objective="min", max_pop=100, max_gen=15)
...
# Debug for mutation operator
p1_mutated = obj._mutation(p1)
p2_mutated = obj._mutation(p2)
