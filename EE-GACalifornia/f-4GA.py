...
genOptimizer = GenHyperOptimizer(model=GradientBoostingRegressor, search_space=GA_Hyperparameter_Range, scoring=mean_absolute_error, objective="min", max_pop=200, max_gen=30, iteration_number=4, elitism_rate=(6.0 / 200), reduction_rate=(4.0 / 200))
