...
genOptimizer = GenHyperOptimizer(model=GradientBoostingRegressor, search_space=GA_Hyperparameter_Range, scoring=mean_absolute_error, objective="min", max_pop=60, max_gen=25, iteration_number=5, elitism_rate=0.05, reduction_rate=0.0)
